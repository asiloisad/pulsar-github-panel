...
export class BareReviewsController extends React.Component {
  ...
  showSummaries = () =>
    new Promise((resolve) => this.setState({ summarySectionOpen: true }, resolve));

  hideSummaries = () =>
    new Promise((resolve) => this.setState({ summarySectionOpen: false }, resolve));

  showComments = () =>
    new Promise((resolve) => this.setState({ commentSectionOpen: true }, resolve));

  hideComments = () =>
    new Promise((resolve) => this.setState({ commentSectionOpen: false }, resolve));
...
export default createFragmentContainer(BareReviewsController, {
  viewer: require("./__generated__/reviewsController_viewer.graphql"),
  repository: require("./__generated__/reviewsController_repository.graphql"),
  pullRequest: require("./__generated__/reviewsController_pullRequest.graphql"),
});
